...
return [
     ...
     */
    'git_repo_template' => '1c-connector-client',
    ...
    'js_args' => [
         ...
         */
        'params' => [
            'npmName' => '@ensi/1c-connector-client',
            'useES6' => true,
    ...
    'php_args' => [
         ...
         */
        'composer_name' => 'ensi/1c-connector-client',
        ...
        'params' => [
            'apiPackage' => 'Api',
            'invokerPackage' => 'Ensi\1cConnectorClient',
            'modelPackage' => 'Dto',
            'packageName' => '1cConnectorClient',
        ],


        'laravel_package_config_key' => 'openapi-clients.1c-connector',
